...
object MonoidDefinition {
  ...
  //      -> Associative -> numbers can be combined in different order and get the same result , 
  //         ie (1 + 3) + 5 = 1 + (3 + 5)
  // an Empty Element -> what to combine to when starting with nothing
  ...
  trait SemiGroup[A] {
    ...
    // if this was addition for ints an implementation would be x + y
  }
